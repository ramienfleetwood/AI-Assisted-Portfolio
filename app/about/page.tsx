  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 py-16 max-w-4xl">
        <h1 className="text-4xl font-bold mb-8 text-gray-900 dark:text-slate-100">About Me</h1>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold mb-2 text-gray-900 dark:text-slate-100">Competencies</h2>
          <p className="text-sm text-gray-500 dark:text-slate-500 mb-6">Skill depth across disciplines</p>
          <SkillBars />
        </section>

        <section className="mb-12">
          <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-slate-100">Experience & Certifications</h2>
          <p className="text-gray-600 dark:text-slate-400 mb-4 text-sm">
            Want a closer look at my career path and credentials?
          </p>
          <Link
            href="/journey"
            className="inline-flex items-center gap-1.5 text-sm bg-blue-700 text-white px-5 py-2.5 rounded-lg hover:bg-blue-800 transition font-medium"
          >
            View My Journey →
          </Link>
        </section>
        ...
        <section>
          <h2 className="text-2xl font-bold mb-2 text-gray-900 dark:text-slate-100">Get In Touch</h2>
          <p className="text-sm text-gray-500 dark:text-slate-500 mb-6">Open to new opportunities and collaborations.</p>
